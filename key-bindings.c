...
key_bindings_init(void)
{
	static const char *const defaults[] = {
		...
		"bind -Tcopy-mode WheelUpPane { select-pane; send -N#{mouse_scroll_lines} -X scroll-up }",
		"bind -Tcopy-mode WheelDownPane { select-pane; send -N#{mouse_scroll_lines} -X scroll-down }",
		...
		"bind -Tcopy-mode-vi WheelUpPane { select-pane; send -N#{mouse_scroll_lines} -X scroll-up }",
		"bind -Tcopy-mode-vi WheelDownPane { select-pane; send -N#{mouse_scroll_lines} -X scroll-down }",
